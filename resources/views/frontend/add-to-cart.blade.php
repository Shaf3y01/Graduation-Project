                ...
                <table class="table table-borderles">
                    ...
                    <tbody>
                        ...
                        @foreach ($cartitems as $item)
                            <tr>
                                <th scope="row">1</th>
                                <td><img src="{{ asset('assets/uploads/products/' . $item->products->image) }}" height="70vh"></td>
                                <td>{{ $item->products->name }}</td>
                                <td>{{ $item->products->selling_pice }}</td>
                                <td>
                            ...
                            @php
                                $total += $item->products->selling_pice * $item->prod_qty;
                            @endphp
                        @endforeach
